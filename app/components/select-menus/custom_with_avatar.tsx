// select menu with custom avatar can be used for showing list of Funds after search in the search bar
...
export default function SelectMenuWithCustomAvatar() {
            ...
            <div className="relative mt-2">
              ...
              <Listbox.Button className="relative w-full cursor-default rounded-md bg-white py-1.5 pl-3 pr-10 text-left text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:outline-none focus:ring-2 focus:ring-indigo-500 sm:text-sm sm:leading-6">
                <span className="flex items-center">
                  {/* Avatar and name of the selected person */}
                      ...
                      {({ selected, active }) => (
                        <>
                          <div className="flex items-center">
                            {/* Avatar and name of this person */}
